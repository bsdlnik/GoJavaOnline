import Utils.CollectionsTimeTest;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        resultTable[22][3] = String.valueOf(timeTest.containsListTest(hashSet, elements, tests, "middle"));
        resultTable[22][4] = String.valueOf(timeTest.containsListTest(treeSet, elements, tests, "middle"));
